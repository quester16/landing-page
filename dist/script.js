...
/* harmony import */ var _postData__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./postData */ "./src/js/modules/postData.js");
...
var Forms = function Forms(state) {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_postData__WEBPACK_IMPORTED_MODULE_9__["default"])('http://localhost:3000/requests', json).then(function (res) {
        console.log(res);
