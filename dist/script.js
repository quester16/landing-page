...
/* harmony import */ var _inputNum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inputNum */ "./src/js/modules/inputNum.js");




var changeState = function changeState(state) {
  var balconForms = document.querySelectorAll('.balcon_icons_img'),
  ...
  (0,_inputNum__WEBPACK_IMPORTED_MODULE_3__["default"])(balconHeight);
  (0,_inputNum__WEBPACK_IMPORTED_MODULE_3__["default"])(balconWidth);
  function bindEventAction(event, elem, prop) {
  ...
  bindEventAction('click', balconForms, 'form');
  bindEventAction('input', balconWidth, 'width');
  bindEventAction('input', balconHeight, 'height');
  bindEventAction('change', select, 'profile');
  bindEventAction('change', checkBox, 'type');
};
...
/* harmony import */ var _postData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./postData */ "./src/js/modules/postData.js");
/* harmony import */ var _inputNum__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inputNum */ "./src/js/modules/inputNum.js");
...
var Forms = function Forms(state) {
  ...
  (0,_inputNum__WEBPACK_IMPORTED_MODULE_7__["default"])(inputsPhone);
  inputsAll.forEach(function (item) {
    return item.setAttribute('required', '');
  });
  var message = {
    loading: 'Loading...',
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      if (form.getAttribute('data-modal-calc') == 'end') {
      ...
      (0,_postData__WEBPACK_IMPORTED_MODULE_6__["default"])('assets/server.php', formData).then(function (res) {
        console.log(res);
        ...
        if (form.getAttribute('data-modal-calc') == 'end') {
          setTimeout(function () {
            (0,_modal__WEBPACK_IMPORTED_MODULE_8__.closeModal)('.popup_calc_end');
          }, 1500);
          state = {};
          console.log(state);
        }
...
var images = function images() {
  var imgPopup = document.createElement('div'),
    ...
    bigImgs = document.createElement('img'),
    scrollWidth = (0,_modal__WEBPACK_IMPORTED_MODULE_0__.calcScroll)();
  imgPopup.style.cssText = "\n    display: none;\n    justify-content: center;\n    align-items: center;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    padding: 20px;\n    z-index: 9;\n    background-color: rgba(0, 0, 0, 0.5);\n  ";
  imgPopup.classList.add('img_popup');
  workSection.appendChild(imgPopup);
  bigImgs.style.cssText = "\n    max-width: 1000px;\n    max-height: 650px;\n  ";
  imgPopup.appendChild(bigImgs);
...
var inputNum = function inputNum(input) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (inputNum);
...
function Modal(timerId) {
  function modals(modalTrigger, modalSelector, modalCloser, timerId) {
    ...
    var modal = document.querySelector(modalSelector),
      ...
      modalClose = document.querySelector("".concat(modalSelector, " ").concat(modalCloser)),
      submitWrapper = document.createElement('submit'),
      // получаем все модальные окна при помощи дата аттребутов
      dataModal = document.querySelectorAll('[data-modal]');

    // for (const item of modalBtn) {
    //   submitWrapper.appendChild(item)
    // }
    ...
    modalBtn.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        // для закрытия всех модальных окон при клике на триггер: modalTrigger
    ...
    modal.addEventListener('click', function (e) {
      if (e.target == modal && closeClickOverlay || e.target == modalClose) {
        closeModal(modalSelector);
      }
    });
  }
  modals('.popup_engineer_btn', '.popup_engineer', '.popup_close strong', timerId);
  modals('.phone_link', '.popup', '.popup_close strong', timerId);
  modals('.popup_calc_btn', '.popup_calc', '.popup_calc_close strong', timerId);
  modals('.popup_calc_btn', '.popup_calc', '.popup_calc_close strong', timerId);
  modals('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close strong', timerId, false);
  modals('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close strong', timerId, false);
}
function calcScroll() {
...
function openModal(modalSelector, timerId) {
  ...
  document.body.style.overflow = 'hidden';
  document.body.style.marginRight = "".concat(scrolling, "px");
...
function Tabs(tabParentSelector, tabSelector, tabContent, activeClass) {
  ...
  function hideTabs() {
    tabsContent.forEach(function (tabElem) {
      return tabElem.style.display = 'none';
    });
...
/* harmony import */ var _modules_changeState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/changeState */ "./src/js/modules/changeState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var timerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.popup', timerId);
  }, 360000);
  var modalState = {};
  (0,_modules_changeState__WEBPACK_IMPORTED_MODULE_6__["default"])(modalState);
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(timerId);
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])(modalState);
